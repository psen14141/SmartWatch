    ...
    public class NurseProfileController : Controller
    {
        public IActionResult Index()
        {
            ...
            using (SmartWatchContext db = new SmartWatchContext())
            {
                var user = db.Users.Join
                   (db.Roles.Where(w => w.RoleName == "Nurse"),
        ...
        public IActionResult AddorEdit(long Id)
        {
            ...
            using (SmartWatchContext db = new SmartWatchContext())
            {
                ...
                profileViewModel.RoleId = db.Roles.Where(y => y.RoleName == "Nurse").Select(x => x.RoleId).FirstOrDefault();
        ...
        public IActionResult SaveProfileNurse(ProfileViewModel profileviewmodel)
        {
            using (SmartWatchContext db = new SmartWatchContext())
            {
            ...
            return Redirect("/Users/NurseProfile/Index");
        }


        public IActionResult EditNurse(long Id)
        {
        ...
        public IActionResult EditSaveProfileNurse(ProfileViewModel profileviewmodel)
        {
            using (SmartWatchContext db = new SmartWatchContext())
            {
                ...
                profile.Profilecol = profileviewmodel.Profilecol;
                profile.Mobile = profileviewmodel.Mobile;
                profile.Address = profileviewmodel.Address;
                profile.City = profileviewmodel.City;
                profile.PostalCode = profileviewmodel.PostalCode;
